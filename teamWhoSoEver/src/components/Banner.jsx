...
import { useAuth } from "@/contexts/Auth"; // your auth context
...
function Banner() {
  ...
  const handleShopClick = () => {
    if (!session) {
      ...
      navigate("/login-callback"); // else go to login callback or dashboard
    }
  };
    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4 z-10 space-y-4">
        ...
        <Button
          ...
          className="bg-gradient-to-r from-green-500 to-lime-400 hover:from-lime-400 hover:to-green-500 text-black font-bold rounded-2xl px-8 py-4 flex items-center gap-3 text-xl shadow-xl transform transition-all duration-300 hover:scale-105 hover:shadow-2xl"
        >
